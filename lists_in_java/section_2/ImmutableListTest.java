...
public class ImmutableListTest {
    ...
    public void equalsConsConsSameElementsLength2() {
        final ImmutableList first = new Cons(1, new Cons(2, new Nil()));  // [1, 2]
        final ImmutableList second = new Cons(1, new Cons(2, new Nil())); // [1, 2]
    ...
    public void sumLength2() {
        assertEquals(3, new Cons(-1, new Cons(4, new Nil())).sum()); // [-1, 4]
    } // sumLength2

    @Test
    public void sumLength3() {
        assertEquals(12, new Cons(6, new Cons(0, new Cons(6, new Nil()))).sum()); // [6, 0, 6]
    } // sumLength3
    // ---END SUM TESTS---
